...
export const projectVideos = {
  ...
  rexxExplainerVideo: "/videos/RexxExplainerVideo.mp4",
};
...
export const roadmapDetails = [
  ...
  },
  {
    ...
    points: [
      ...
      "Secure experienced advisors who can guide the project.",
      "Launch a professional website detailing the project information.",
    ],
  },
  {
    title: "",
    ...
    points: [
      ...
      "Token sale program launched.",
      "Start the presale with a defined start and end date.",
      "Update the project roadmap based on achieved milestones and new objectives.",
  ...
  {
    title: "Beta Testing and Launch of ReXXchange; Development of ReXXverse",
    company_name: "Meta",
    icon: "/meta.png",
    iconBg: "#E6DEDD",
    date: "Q2 2024",
  ...
  },
  {
    ...
    points: [
      "> ReXXpress",
      "Implement community-driven content curation.",
      "Launch the full version for public access.",
      "> ReXXverse",
  ...
  {
    title: "Launch of ReXXverse; Development and Testing of ReXXconnect",
    company_name: "Meta",
    icon: "/meta.png",
    iconBg: "#E6DEDD",
    date: "Q4 2024",
  ...
  {
    title: "Launch of ReXXconnect; Development of ReXXplorer and ReXXVault",
    company_name: "Meta",
    icon: "/meta.png",
    iconBg: "#E6DEDD",
    date: "Q1 2025",
    points: [
      ...
      "Source global blockchain activity data.",
      "Develop an interactive map interface.",
      "> ReXXVault (Decentralized Wallet)",
      "Start development on multi-cryptocurrency support.",
      "Design a user-centric interface.",
    ],
  },
  {
    title: "Beta Testing of ReXXplorer and ReXXVault; Development of ReXXchain",
    company_name: "Meta",
    icon: "/meta.png",
    iconBg: "#E6DEDD",
    date: "Q2 2025",
  ...
  {
    title: "Launch of ReXXchain and Final Development of ReXXpay",
    company_name: "Meta",
    icon: "/meta.png",
    iconBg: "#E6DEDD",
    date: "Q4 2025",
    points: [
      ...
      "Full public launch.",
      "ReXXpay",
      "Rollout beta payment gateway to select gaming platforms.",
      "Prepare for the public launch in Q1 2026.",
    ],
  },
];
